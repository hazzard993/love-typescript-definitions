declare module "love.audio" {
     ...
     */
    export interface Source extends LoveObject<"Source"> {
        /**
         ...
         * @return filtersettings, The settings for the filter associated to this effect, or _nil/undefined_ if the effect is not present in this Source or has no filter associated.
         ...
         * @return settings, The filter settings to use for this Source, or nil/undefined if the Source has no active filter.
