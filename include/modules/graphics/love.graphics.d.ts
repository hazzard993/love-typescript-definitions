declare namespace love {
    ...
    export namespace graphics {
		 ...
		 */
		export function newArrayImage(slices: ImageInformation[], settings?: ArrayImageSettings): Image;
		 ...
		 */
		export function newVolumeImage(layers: ImageInformation[], settings?: ImageSettings): Image;
		 ...
		 */
        export function polygon(mode: DrawMode, ...xys: number[]): void;
