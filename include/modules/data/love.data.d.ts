declare namespace love {
    ...
    export namespace data {
         ...
         * @link [love.audio.decode](https://love2d.org/wiki/love.audio.decode)
         */
         ...
         * @param container What type to return the encoded data as.
         * @param format The format of the output data.
         * @param sourceData The raw data to encode.
         * @param linelength The maximum line length of the output. Only supported for base64, ignored if 0.
         * @return {ByteData | string} encoded, ByteData/string which contains the encoded version of source.
         * @link [love.data.encode](https://love2d.org/wiki/love.data.encode)
         */
        export function encode(container: ContainerType, format: EncodeFormat, sourceData: Data, linelength?: number): ByteData | string;
        export function encode(container: "string", format: EncodeFormat, sourceData: Data, linelength?: number): string;
        export function encode(container: "data", format: EncodeFormat, sourceData: Data, linelength?: number): ByteData;
